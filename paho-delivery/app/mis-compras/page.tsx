...
import { CheckCircle2, Clock, Truck, MapPin, Mail } from "lucide-react";
            ...
            {pedidos.map((p) => (
              <div key={p.id} className="ficha bg-white border border-line p-4">
                ...
                <div className="mt-3 flex items-center flex-wrap gap-2">
                  {p.entrega === "entregado" ? (
                    <span className="inline-flex items-center gap-1.5 text-xs text-moss font-medium">
                    ...
                    <span className="inline-flex items-center gap-1.5 text-xs text-amber-dark font-medium">
                      <Truck size={13} />
                      {p.envio?.metodo === "domicilio"
                  ...
                  {p.estado === "pagado" && (
                    <Link
                      href={`/mis-compras/${p.id}/mensajes`}
                      className="inline-flex items-center gap-1.5 text-xs text-ink border border-line rounded-stamp px-2.5 py-1.5 hover:border-ink/40 transition-colors"
                    >
                      <Mail size={13} />
                      Mensajes
                    </Link>
